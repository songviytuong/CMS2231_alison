...
class CGSmartImage extends CGExtensions
{
    ...
    function GetVersion() { return '1.21.9'; }
    function MinimumCMSVersion() { return '1.12.1'; }
    function GetDependencies() { return array('CGExtensions'=>'1.53.1');   }
    ...
    public function get_tasks()
    {
        ...
        if( \cms_utils::get_module('CGMessageQueue') ) $out[] = new \CGSmartImage\AutoProcessMasterTask();
        return $out;
    }
