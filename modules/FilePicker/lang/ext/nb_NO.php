...
$lang['can_mkdir'] = 'Tillat Katalog Skapelse';
...
$lang['filepickertitle'] = 'CMSMS filbehandler';
...
<p>Denne modulen gir den generiske evne til å la en autorisert admin editor for å velge en fil. I.e: å velge et bilde for bruk i et WYSIWYG-felt, eller for å knytte et bilde eller miniatyrbilde med en side, eller legge ved en PDF-fil til en nyhetsartikkel. Modulen har også en liten mengde tilleggsfunksjonalitet som tillater autoriserte brukere å laste opp og slette filer, eller å opprette og fjerne underkataloger.</p>
