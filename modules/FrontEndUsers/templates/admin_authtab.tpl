...
<div class="information">{$mod->Lang('info_star')}</div>
<div class="pageoverflow">
...
<div class="pageoverflow">
  <p class="pagetext">{$mod->Lang('prompt_verify_page')}:</p>
  <p class="pageinput">
    <input type="text" name="{$actionid}pageid_onverify" value="{$pageid_onverify}" size="80" maxlength="255"/>
  </p>
</div>
<div class="pageoverflow">
