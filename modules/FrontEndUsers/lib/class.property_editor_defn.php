...
class property_editor_defn
{
    ...
    public function __construct($propdefn,$relation,user_edit_assistant &$user)
    {
        ...
        $this->_req_color = \feu_utils::get_mod()->GetPreference('required_field_color','blue');
        $this->_hidden_color = \feu_utils::get_mod()->GetPreference('hidden_field_color','green');
        $this->_req_marker = \feu_utils::get_mod()->GetPreference('required_field_marker','*');
        $this->_hidden_marker = \feu_utils::get_mod()->GetPreference('hidden_field_marker','!!');
    }
    ...
    public function set_value($val)
    {
        ...
        case 0: // text field
            $val = (string) $val;
            $l = strlen($val);
            if( $l > $this->maxlength ) throw new \CmsInvalidDataException($mod->Lang('error_fldvallength',$this->name));
