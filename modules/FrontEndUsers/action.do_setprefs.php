...
$randomusername = 0;
if( isset( $params['input_randomusername']) ) $randomusername = (int)$params['input_randomusername'];
$this->SetPreference('use_randomusername',$randomusername);
if( isset( $params['input_expireage']) ) $this->SetPreference('expireage_months',(int)$params['input_expireage']);

$this->SetPreference('user_session_expires', $params['input_sessiontimeout']);

$cookie_keepalive = 0;
if( isset( $params['input_cookiekeepalive'] ) ) $cookie_keepalive = $params['input_cookiekeepalive'];
$this->SetPreference('cookie_keepalive',$cookie_keepalive);
if( isset($params['input_signin_button']) ) $this->SetPreference('signin_button', $params['input_signin_button']);
...
if (isset($params['notifications'])) $this->SetPreference('notifications',implode(',',$params['notifications']));
...
if( isset( $params['input_feusers_specific_permissions'] ) ) $feusers_specific_permissions = $params['input_feusers_specific_permissions'];
...
if( isset($params['pagetype_groups']) ) $this->SetPreference('pagetype_groups',implode(',',$params['pagetype_groups']));
