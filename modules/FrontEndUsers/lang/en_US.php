<?php
$lang['warn_strongpassword'] = 'Note, by default, strong passwords are a requirement, though the settings for passwords can be controlled from within the admin panel for this module';
$lang['code'] = 'Code';
$lang['verify'] = 'Verify';
$lang['info_verify_identity'] = 'Please enter the verification code you received in this form <em>(it may even automatically be provided).</em> to verify your account.';
...
$lang['error_validate_insufficientinfo'] = 'This user must revalidate himself, but there is not enough user information available to make that possible.';
$lang['info_must_validate'] = 'This user must validate themselves before logging in';
...
$lang['error_fldvallength'] = 'The value specified for %s too long';
...
$lang['prompt_force_revalidate'] = 'This user must validate themeselves before the next login';
...
';
$lang['event_help_AfterLoginAuth'] = '
<h3>OnLogin<h3>
<p>An event sent when a user logs in<, after authentication, but before session information is created, and the system recognizes him as logged in.
This event can be used by third party modules to aide in security for FEU.</p>
<h4>Parameters</h4>
<ul>
...
<li><em>allow</em> - boolean reference indicating whether the user should be allowed to login.  Modules can set this to false to disallow login.</li>
<li><em>msg</em> - string message to indicate the nature of the problem if a module has set allow to false.</li>
</ul>
';
$lang['event_help_BeforeLogin'] = '
<h3>OnLogin<h3>
<p>An event sent when a user logs in<, after login form submission, but before they are authenticated...
This event can be used by third party modules to aide in security for FEU.</p>
<h4>Parameters</h4>
<ul>
<li><em>id</em> - The id of the logged in user</li>
...
';
$lang['event_help_OnLoginFailed'] = '
<h3>OnLoginFailed<h3>
<p>An event generated when a user login fails</p>
<h4>Parameters</h4>
<ul>
<li><em>username</em> - The name of the logged in user</li>
<li><em>msg</em> - A message indicating why the login failed./li>
</ul>
';
...
';
$lang['event_info_AfterLoginAuth'] = 'An event generated after authentication, but before actually logging the user in.';
$lang['event_info_BeforeLogin'] = 'An event generated when a user logs in to the system, after he is has submitted the login form, but before any authentication is tested.';
$lang['event_info_OnLogin'] = 'An event generated when a user logs in to the system';
$lang['event_info_OnLoginFailed'] = 'An event generated when a user fails to log in to the system';
