...
<div class="row">
  ...
  <div class="col-sm-10">
    {product_ops::get_currency_symbol()}{$entry->price|number_format:2}
  </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      <span style="color: red;">{product_ops::get_currency_symbol()}{$foo.discount|number_format:2} ({$foo.percentage|number_format:2}%)</span>
    </div>
  </div>
  {/if}
{/if}
...
<div class="row">
  ...
  <div class="col-sm-10">
    {$entry->weight|number_format:2} {product_ops::get_weight_units()}
  </div>
</div>
{/if}
...
{if $entry->hierarchy_id}
  <p>Items in this hierarchy: <a href="{cms_action_url action=default hierarchyid=$entry->hierarchy_id}">Go</a>
{/if}
