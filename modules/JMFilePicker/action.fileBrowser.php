...
if(file_exists($current_dir))
{
	...
	$smarty->assign_by_ref('jmfp_files', $files);
	...
	if($this->_isAdmin || $params['show_subdirs'])
	{
		...
		$smarty->assign_by_ref('jmfp_breadcrumbs', $breadcrumbs);
		$smarty->assign_by_ref('jmfp_breadcrumbs', $breadcrumbs);
		...
		$smarty->assign_by_ref('jmfp_startlink',$start_link);
		$smarty->assign_by_ref('jmfp_starturl',$start_url);
...
if($this->_isAdmin || $params['show_subdirs'])
{
	...
	$smarty->assign_by_ref('jmfp_currentdir', $dir);
}
...
if(isset($errormessage))
{
	$smarty->assign_by_ref('jmfp_errormessage', $errormessage);
}
if(isset($message))
{
	$smarty->assign_by_ref('jmfp_message', $message);
}
