...
echo $this->SetTabHeader('handling',$this->Lang('tab_handling_settings'));
...
include dirname(__FILE__).'/action.admin_packaging_tab.php';
echo $this->EndTab();

echo $this->StartTab('handling');
include dirname(__FILE__).'/function.admin_handling_tab.php';
echo $this->EndTab();
