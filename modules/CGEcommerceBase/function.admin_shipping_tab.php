...
$module_list = null;
$tmp_module_list = module_helper::get_modules_by_interface('\CGEcommerceBase\shipping_module');
...
if( isset($params['shipping_submit']) ) $this->SetPreference('shipping_module',trim($params['shipping_module']));
