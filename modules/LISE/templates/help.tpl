...
<div id="page_content">
  ...
  <div id="whatsnew_c">
    <div class="pageoverflow">
      ...
      <ul> 
        <li>
          New field definition: <strong>JQueryMultiSelect</strong>;
        </li> 
        <li>
          Categories: now have the option to use <strong>JQueryMultiSelect</strong>;
        </li> 
        <li>
          New field definitions: <strong>FEUMultiSelect</strong>, <strong>FEUSingleSelect</strong> (<strong>FEUDropdown</strong> is now deprecated and will be removed at some point in the future: use <strong>FEUSingleSelect</strong> instead);
        </li>
        <li>
      ...
      <p>These are some of the fixes of the latest releases:</p>
      <ul> 
