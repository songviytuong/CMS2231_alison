...
$lang['fielddef_JMFP_allow_help'] = 'Specify a comma seprated list of file extensions that are allowed. For example: pdf,gif,jpeg,jpg (keep lowercase)';
...
$lang['fielddef_JMFP_delete_help'] = 'If enabled you can grant deleting files or directories for this field even to users without apropriate permission.';
$lang['fielddef_JMFP_create_dirs_help'] = 'If enabled you can grant creation of directories for this field even to users without apropriate permission.';
...
$lang['fielddef_render_for_admin_listing_udt'] = 'Select the Admistrator Listing UDT';
...
$lang['prompt_import_from_LI2'] = 'Import from existing LI2 intances';
...
$lang['help_fielddefs'] = '<h3>Field Definitions</h3>
    ...
    <ul>
      ...
      <li>FEUDropdown - <strong>FrontEndUsers Dropdown (1)(5) <span style="color:orange">(deprecated)</span></strong>;</li>
      <li>FEUMultiSelect - <strong>FEU Multi Select (1) <span style="color:green">(new)</span></strong>;</li>
      <li>FEUSingleSelect - <strong>FEU Single Select (1) <span style="color:green">(new)</span></strong>;</li>
      <li>FileUpload - <strong>File Upload</strong>;</li>
      <li>GalleryDropdown - <strong>Gallery Dropdown (2)</strong>;</li>
      <li>GBFilePicker - <strong>GBFilePicker Upload File (3)(5) <span style="color:orange">(deprecated)</span></strong>;</li>
      <li>JMFilePicker - <strong>JMFilePicker Upload File (4)</strong>;</li>
      <li>JQueryMultiSelect - <strong>JQuery MultiSelect <span style="color:green">(new)</span></strong>;</li>
    ...
    <p>(1) Has dependencies: <strong>FrontEndUser</strong>s and <strong>CGExtensions</strong>;</p>
    <p>(2) Has dependencies: <strong>Gallery</strong>;</p>
    <p>(3) Has dependencies: <strong>GBFilePicker</strong>. <em>Note: It only works with CMSMS 1.x branch</em>;</p>
    <p>(4) Has dependencies: <strong>JMFilePicker</strong>.</p>
    <p>(5) Deprecated: <strong>will be removed in a near future, use the replacements ASAP</strong>.</p>
    ';
